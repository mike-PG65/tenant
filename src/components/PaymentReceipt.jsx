...
const PaymentReceipt = forwardRef(({ payment, onDownload }, ref) => {
  ...
  return (
    <div ref={ref} className="max-w-2xl w-full mx-auto mt-6 sm:mt-10 bg-white rounded-2xl shadow-2xl overflow-hidden">
      {/* PAGE 1 */}
      <div className="page p-6 sm:p-10 bg-white">
        {/* Watermark */}
        <div className="absolute inset-0 opacity-5 pointer-events-none flex items-center justify-center text-4xl sm:text-6xl font-bold text-gray-300 -rotate-30">
          RECEIPT
        </div>

        {/* Header */}
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-6 sm:mb-8 relative text-center sm:text-left">
          <div>
      ...
      <div className="page p-6 sm:p-10 bg-gray-100">
        {/* Payment Summary */}
        <div className="rounded-xl shadow-inner p-4 sm:p-6">
          <h3 className="text-base sm:text-lg font-semibold text-gray-800 mb-3 border-b border-gray-300 pb-2">
            Payment Summary
          </h3>
        ...
        {/* Footer */}
        <p className="text-center text-gray-600 italic mb-4 text-sm sm:text-base mt-6">
        ...
        <div className="flex justify-center mb-6">
          <button
            onClick={onDownload}
            className="px-4 sm:px-6 py-2.5 sm:py-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-xl shadow-md transition-transform transform hover:scale-105 text-sm sm:text-base"
          >
